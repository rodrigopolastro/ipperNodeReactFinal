              ...
              <div className="relative flex flex-col text-center lg:text-right">
                ...
                >
                  <div className="relative inline-flex flex-col">
                    <img className="md:max-w-none mx-auto rounded" src={Seguranca} width={500} height="462" alt="Features bg" />
                    </div>
                </Transition>
                {/* Item 2 */}
                <Transition
                ...
                >
                  <div className="relative inline-flex flex-col">
                    <img className="md:max-w-none mx-auto rounded" src={Verificacao} width={500} height="462" alt="Features bg" />
                    </div>
                </Transition>
                {/* Item 3 */}
                <Transition
                ...
                >
                  <div className="relative inline-flex flex-col">
                    <img className="md:max-w-none mx-auto rounded" src={Aviso} width={500} height="462" alt="Features bg" />
                  </div>
                </Transition>
              </div>
            </div>
